...
#ifndef HTTPBYPASSUPDATE_H_
#define HTTPBYPASSUPDATE_H_
...
class HTTPBypassUpdate
{
public:
    HTTPBypassUpdate(void);
    ~HTTPBypassUpdate(void);
...
protected:
    t_httpUpdate_return handleUpdate(HTTPBypass& http, const String& currentVersion, bool spiffs = false);
...
extern HTTPBypassUpdate bypassUpdate;

#endif /* HTTPBYPASSUPDATE_H_ */
