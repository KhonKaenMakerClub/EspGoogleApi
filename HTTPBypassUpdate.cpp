...
HTTPBypassUpdate::HTTPBypassUpdate(void)
{
}
...
HTTPUpdateResult HTTPBypassUpdate::update(const String& url, const String& currentVersion,
...
HTTPUpdateResult HTTPBypassUpdate::updateSpiffs(const String& url, const String& currentVersion, const String& httpsFingerprint)
{
    HTTPBypass http;
    http.begin(url, httpsFingerprint);
...
HTTPUpdateResult HTTPBypassUpdate::updateSpiffs(const String& url, const String& currentVersion)
{
    HTTPBypass http;
    http.begin(url);
    return handleUpdate(http, currentVersion, true);
...
HTTPUpdateResult HTTPBypassUpdate::update(const String& host, uint16_t port, const String& uri, const String& currentVersion,
...
HTTPUpdateResult HTTPBypassUpdate::update(const String& host, uint16_t port, const String& uri,
...
HTTPUpdateResult HTTPBypassUpdate::update(const String& host, uint16_t port, const String& url,
 ...
 */
int HTTPBypassUpdate::getLastError(void)
{
    return _lastError;
}
 ...
 * @return String error
 */
String HTTPBypassUpdate::getLastErrorString(void)
{
    ...
    if(_lastError > -100) {
        return String(F("HTTP error: ")) + HTTPBypass::errorToString(_lastError);
    }
...
/**
 *
 * @param http HTTPBypass *
 * @param currentVersion const char *
 * @return HTTPUpdateResult
 */
HTTPUpdateResult HTTPBypassUpdate::handleUpdate(HTTPBypass& http, const String& currentVersion, bool spiffs)
{
 ...
 */
bool HTTPBypassUpdate::runUpdate(Stream& in, uint32_t size, String md5, int command)
{
